...
<head>
    ...
    <title>Verifikasi Kode Aktivasi — Sistem SPKLU</title>
    <!-- Favicon -->
...
<body>
    <div class="act-card">
        <div class="act-header">
            ...
            <h1>Verifikasi Kode Aktivasi</h1>
            <p>Kode verifikasi sudah dikirim ke<br><strong>{{ $user->email }}</strong></p>
        </div>
        ...
        <div class="act-body">
            ...
            <div class="act-info-box">
                ...
                <span>Kode berlaku selama 10 menit. Setelah verifikasi berhasil, Anda akan diminta membuat password baru.</span>
            </div>
