...
<div class="fsf-wrap">
    {{-- KOLOM KIRI: FORM — strukturnya PERSIS sama seperti Tambah FS Skema,
         cuma nilai awal field diisi dari data $fsSkema yang sudah ada, dan
         tidak ada lagi dropdown "Kandidat Terkait" terpisah (itu sumber
         error "Undefined variable $kandidatList" sebelumnya) — kandidat
         tetap otomatis nyambung lewat kandidat_id hidden field, sama
         seperti alur combobox lokasi di form Tambah. --}}
    <div class="fsf-card">
        <form method="POST" action="{{ route('fs-skema.update', $fsSkema) }}" id="form-fs-skema">
            ...
            <div id="blok-skema-2">
                <div class="fsf-row">
                    ...
                    <div class="fsf-field">
                        ...
                        <input type="number" name="mobil_per_hari" value="{{ old('mobil_per_hari', $fsSkema->mobil_per_hari) }}" placeholder="Masukan asumsi mobil per hari" required data-preview-trigger>
                    </div>
                </div>
            </div>
            ...
            <div id="blok-skema-3" class="fsf-skema3-only">
                ...
                <div class="fsf-row">
                    <div class="fsf-field">
                        <label>Mobil/hari</label>
                        <input type="number" name="mobil_per_hari_skema3" value="{{ old('mobil_per_hari', $fsSkema->mobil_per_hari) }}" placeholder="Masukan asumsi mobil per hari" data-preview-trigger>
                    </div>
                    <div class="fsf-field">
                        <label>Sharing Profit Mitra Lahan</label>
                        <input type="number" step="0.01" min="0" max="1" name="sharing_provit_mitra_lahan" value="{{ old('sharing_provit_mitra_lahan', $fsSkema->sharing_provit_mitra_lahan ?? 0.10) }}" placeholder="0.10" data-preview-trigger>
            ...
            <div class="fsf-row">
                <div class="fsf-field">
                    ...
                    <input type="number" step="0.01" name="transaksi_kwh_per_mobil" value="{{ old('transaksi_kwh_per_mobil', $fsSkema->transaksi_kwh_per_mobil) }}" placeholder="Masukan Transaksi kWh/mobil" required data-preview-trigger>
                </div>
                <div class="fsf-field">
